...
#keras_model,im, file,
def export_tfjs( prefix=colorstr('TensorFlow.js:')):
    ...
    try:
        ...
        f='efficient_web_model'
        f_pb = './model_all/saved_model.pb' # *.pb path
...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / 'efficient.pt', help='model.pt path(s)')
    parser.add_argument('--imgsz', '--data', '--data-size', nargs='+', type=int, default=[224, 224], help='image (h, w)')
...
#     --output_node_names='efficient_web_model/Reshape_1' \
#     ./model_all/saved_model.pb \
#     ./model_all/web_model
#
# tensorflowjs_converter \
